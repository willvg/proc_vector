...
int main()
{
      ...
      char RSL1[] = "10111100000000001111000000000000";
      char RSL2[] = "10111100000100011111000000000000";
      char RSL3[] = "10111100001000101111000000000000";
      char RSL4[] = "10111100001100111111000000000000";
      ...
      FILE *archivo;
      archivo = fopen ( "memoriaInstrRSL256.txt", "a" );        
