...
int main()
{
      ...
      char Sum0[] = "00101100000000001111000000000000";
      char Sum1[] = "00101100000100011111000000000000";
      char Sum2[] = "00101100001000101111000000000000";
      char Sum3[] = "00101100001100111111000000000000";
      ...
      FILE *archivo;
      archivo = fopen ( "memoriaInstrr.txt", "a" );        
